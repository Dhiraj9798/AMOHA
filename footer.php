    <!-- WHITE THEME FOOTER - SINGLE GLASSMORPHIC CARD -->
    <footer class="footer-white-theme bg-white relative overflow-hidden">
        <!-- Main Container -->
        <div class="relative z-10 max-w-7xl mx-auto px-6 md:px-12 py-16">
            
            <!-- Single Large Glassmorphic Card -->
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div class="relative group">
                        <div class="flex items-center gap-3 mb-4">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-brand-red">Logistics</p>
                            </div>
                        </div>
                        ...
                        <div class="flex gap-2">
                            ...
                            <a href="#" class="w-8 h-8 rounded-full bg-brand-red/10 hover:bg-brand-red/30 flex items-center justify-center text-brand-red transition-all hover:scale-110" title="Instagram">
                                <i data-lucide="instagram" class="w-4 h-4"></i>
                            </a>
                            <a href="#" class="w-8 h-8 rounded-full bg-brand-red/10 hover:bg-brand-red/30 flex items-center justify-center text-brand-red transition-all hover:scale-110" title="LinkedIn">
                    ...
                    <div class="relative group">
                        ...
                        <ul class="space-y-2">
                            ...
                            <li><a href="about-us.php" class="text-sm text-gray-700 hover:text-brand-red transition-colors flex items-center gap-2 group/link">
                                <span class="w-0 h-0.5 bg-brand-red group-hover/link:w-2 transition-all"></span> About Us
                            </a></li>
                            <li><a href="gallery.php" class="text-sm text-gray-700 hover:text-brand-red transition-colors flex items-center gap-2 group/link">
                                <span class="w-0 h-0.5 bg-brand-red group-hover/link:w-2 transition-all"></span> Gallery
                            </a></li>
                            <li><a href="contact.php" class="text-sm text-gray-700 hover:text-brand-red transition-colors flex items-center gap-2 group/link">
                                <span class="w-0 h-0.5 bg-brand-red group-hover/link:w-2 transition-all"></span> Contact
                            </a></li>
                        </ul>
                    </div>
                    ...
                    <div class="relative group">
                        ...
                        <ul class="space-y-2">
                            ...
                            <li><a href="truck-operations.php" class="text-sm text-gray-700 hover:text-brand-red transition-colors flex items-center gap-2 group/link">
                                <span class="w-0 h-0.5 bg-brand-red group-hover/link:w-2 transition-all"></span> Truck Ops
                            </a></li>
                            <li><a href="loading-delivery.php" class="text-sm text-gray-700 hover:text-brand-red transition-colors flex items-center gap-2 group/link">
                                <span class="w-0 h-0.5 bg-brand-red group-hover/link:w-2 transition-all"></span> Loading
                            </a></li>
                            <li><a href="transport-partner-program.php" class="text-sm text-gray-700 hover:text-brand-red transition-colors flex items-center gap-2 group/link">
                                <span class="w-0 h-0.5 bg-brand-red group-hover/link:w-2 transition-all"></span> Partners
                            </a></li>
                        </ul>
                    </div>
    ...
    <style>
        ...
        .main-footer-card::before {
            content: '';
            position: absolute;
            inset: 0;
            background: linear-gradient(135deg, rgba(155,0,20,0.08) 0%, rgba(155,0,20,0) 100%);
            pointer-events: none;
            opacity: 0;
            transition: opacity 0.3s ease;
        }

        .main-footer-card:hover::before {
            opacity: 1;
        }
